...
import com.store.mapper.ISysRoleDeptMapper;
import com.store.mapper.ISysRoleMapper;
import com.store.model.SysRole;
import com.store.model.SysRoleDept;
...
public class SysRoleServiceImpl extends ServiceImpl<ISysRoleMapper, SysRole> implements ISysRoleService {
    ...
    @Autowired
    private ISysRoleDeptMapper sysRoleDeptMapper;
