...
public class ReflectionUtils {
	...
	public static Field getAccessibleField(final Object obj, final String fieldName) {
		...
		try {
			Validator.validateNotNull(obj, "object can't be null");
			Validator.validateNotNull(fieldName, "fieldName can't be blank");
		} catch (ValidateException e) {
			logger.error("异常状态码：{}",e.getStatus());
			e.printStackTrace();
	...
	public static Method getAccessibleMethod(final Object obj, final String methodName,
		...
		try {
			Validator.validateNotNull(obj, "object can't be null");
			Validator.validateNotNull(methodName, "methodName can't be blank");
		} catch (ValidateException e) {
			logger.error("异常状态码：{}",e.getStatus());
			e.printStackTrace();
			throw new NullPointerException(e.getMessage());
